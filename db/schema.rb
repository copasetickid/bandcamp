...
ActiveRecord::Schema.define(version: 20151208213757) do
  ...
  add_index "tag_tickets", ["tag_id", "ticket_id"], name: "index_tag_tickets_on_tag_id_and_ticket_id", using: :btree
  add_index "tag_tickets", ["ticket_id", "tag_id"], name: "index_tag_tickets_on_ticket_id_and_tag_id", using: :btree
